/*
  ...
  2. Security
    ...
    - Adds claimed_at timestamp and claimed_by user ID
    - Only affects unclaimed tickets

  3. Changes
    - Updates all unclaimed tickets to claimed status
    - Sets claimed_at to current timestamp
    - Sets claimed_by to the admin user who executed the function
*/

-- Create function to reset all tickets
