/*
  ...
  1. Changes
    ...
    - Create unified missions table with proper enums
    - Set up proper relationships and constraints
    - Add initial mission data
...
-- Drop existing tables if they exist
DROP TABLE IF EXISTS user_missions_progress CASCADE;
DROP TABLE IF EXISTS user_missions CASCADE;
DROP TABLE IF EXISTS missions CASCADE;
DROP TABLE IF EXISTS user_social_missions CASCADE;
DROP TABLE IF EXISTS social_missions CASCADE;

-- Drop existing enum if it exists
DROP TYPE IF EXISTS mission_type CASCADE;
DROP TYPE IF EXISTS mission_status CASCADE;

-- Create mission types enum with all required values
