/*
  ...
  1. New Functions
    - `get_available_points_v2`: Calculates total available points for a user
    - `get_pending_points_v2`: Calculates pending points for a user
    - `handle_points_deduction`: Handles point deduction for roulette spins

  2. Changes
    - Drop existing trigger and functions to avoid conflicts
    - Add new functions with improved logic
    - Add new trigger for roulette spins
