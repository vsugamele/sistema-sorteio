/*
  ...
  1. Changes
    - Add functions to calculate available and pending points
    - Add points deduction handling for roulette spins
    - Improve error handling and validation

  2. Functions
    - get_available_points_v2: Calculate total available points
    - get_pending_points_v2: Calculate pending points
    - handle_points_deduction: Validate and handle points deduction
*/
